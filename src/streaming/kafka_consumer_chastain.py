...
from streaming.visualizations.live_visualizations_chastain import (
    close_live_chart,
    init_live_chart,
    save_live_chart,
    update_live_chart,
...
OUTPUT_CHART: Final[Path] = OUTPUT_DIR / "sales_chart_chastain.png"
...
def initialize_output() -> tuple[Any, Any, list[str], list[float], RunningStats]:
